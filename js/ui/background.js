    ...
    root.innerHTML = `
      ...
      <main class="screen background-screen">
        ...
        <div class="lesson-card bg-card">
          ...
          ${sectionsHTML}
          <button class="btn-primary lesson-start-btn" data-back-bottom>Back to Island &rarr;</button>
        </div>
      </main>
    `;

    wireHud(root, navigate);
    const goBack = () => navigate("island", { subjectId });
